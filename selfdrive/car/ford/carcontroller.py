...
from openpilot.selfdrive.car import apply_std_steer_angle_limits #, DT_CTRL  # for applying safety limits
...
def curvature_to_steering_angle(curvature, steer_ratio, wheelbase):
  """
  Convert road curvature to steering wheel angle
  Args:
    curvature: Road curvature in 1/meter
    steer_ratio: Ratio between steering wheel angle and road wheel angle
    wheelbase: Vehicle wheelbase in meters
  Returns:
    Steering wheel angle in degrees
  """
  road_wheel_angle = np.arctan(wheelbase * curvature)
  road_wheel_angle_deg = np.degrees(road_wheel_angle)
  steering_angle = road_wheel_angle_deg * steer_ratio
...
class CarController(CarControllerBase):
  def __init__(self, dbc_name, CP, VM):
    ...
    self.lane_change_factor_low = 0.80 # lane_change_factor at 4.4 m/s
    self.lane_change_factor_high = 0.60 # updated from UI: lane_change_factor at 40.23 m/s
    self.requested_curvature_filtered = FirstOrderFilter(0.0, 0.3, 0.05)  # filter for apply_curvature
    self.pc_blend_ratio_low = 0.50 # 60% Predicted Curvature and 40% Desired Curvature
    self.pc_blend_ratio_mid = 0.40 # 50% Predicted Curvature and 50% Desired Curvature
    self.pc_blend_ratio_high = 0.30 # 40% Predicted Curvature and 60% Desired Curvature
    self.pc_blend_ratio_UI = 0.40 # 60% Predicted Curvature and 40% Desired Curvature
    ...
    self.path_angle_high_speed_factor_low = 2.0 # path_angle_speed_factor at 40.23 m/s
    ...
    self.path_angle_high_curvature_factor_low = 0.25 # path_angle_curvature_factor at 0.002
    self.path_angle_high_curvature_factor_mid = 0.17 # path_angle_curvature_factor at 0.002
    self.path_angle_high_curvature_factor_high = 0.1 # path_angle_curvature_factor at 0.002
    self.path_angle_high_curvature_factor_UI = 0.17 # path_angle_curvature_factor at 0.002
    ...
    self.curvature_max = 0.0  # too much curvature can cause steering windup
    ...
    self.max_path_angle_change = 0.0025
    self.max_path_offset_change = 0.005
    self.max_curvature_rate_change = 0.0002
  ...
  def handle_post_lane_change_transition(self, path_angle, path_offset, desired_curvature_rate):
    ...
    if self.post_lane_change_active:
        ...
        if self.post_lane_change_timer >= 80:
            self.post_lane_change_active = False
