...
def hardware_thread(end_event, hw_queue) -> None:
  ...
  while not end_event.is_set():
    ...
    # BluePilot: bp-7.0-c3 is a dedicated C3 compatibility port. Do not gate onroad
    # operation on branch/channel naming, and clear any alert left by older builds.
